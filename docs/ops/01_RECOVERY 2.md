...
a subcommand of the one host client (`mode_console`, `host/ocbm-host/src/main.rs:375`), which claims
...
`main.rs:391`.)* Nice-to-haves for cheap: a `resize` TLV (window size/`TERM`), multiple sessions via a
